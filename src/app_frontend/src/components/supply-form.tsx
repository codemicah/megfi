...
export function SupplyForm({ symbol }: SupplyFormProps) {
  ...
  return (
    <div className="relative bg-gradient-to-b from-[#6366F1]/20 to-[#8B5CF6]/20 rounded-3xl p-6 backdrop-blur-xl">
      <div className="mb-8">
        <h3 className="text-2xl font-semibold mb-2">Supply</h3>
        <p className="text-gray-400">Enter how much {symbol} to supply</p>
      </div>
